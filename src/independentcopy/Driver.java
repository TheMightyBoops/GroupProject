...
//		Writer writer = new GuiWriter();
		...
		ListWriter addToNewList = new ListWriter(list);
		addToNewList.writeln("Name");
		addToNewList.writeln("String");
		addToNewList.writeln("String");
		ListReader readTheList = new ListReader(addToNewList.getList());
		System.out.println(readTheList.readln());
